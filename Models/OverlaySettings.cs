...
namespace BestInScript.API.Models
{
    ...
    public class OverlaySettings
    {
        ...
        /// <summary>World-boss row config. Alarm defaults ON (warn at 30 min, blink last 5).</summary>
        public EventOverlayConfig WorldBoss { get; set; } = new() { AlarmEnabled = true, WarningLeadMinutes = 30, AlarmLeadMinutes = 5 };
